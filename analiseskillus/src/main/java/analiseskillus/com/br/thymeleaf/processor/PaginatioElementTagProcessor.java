package analiseskillus.com.br.thymeleaf.processor;
...
public class PaginatioElementTagProcessor extends AbstractElementTagProcessor {

	private static final String NOME_TAG = "pagination";
	private static final int PRECEDENCIA = 1000;
	
	public PaginatioElementTagProcessor(String dialectPrefix) {
